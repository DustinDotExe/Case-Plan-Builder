...
document.addEventListener('DOMContentLoaded', function() {
    ...
    showAlert = function(message, type = 'info') {
        ...
        alert.classList.add('mb-4', 'p-4', 'rounded-md', 'border', 'shadow-sm', 'transition-all', 'duration-300', 'transform', 'translate-y-0', 'opacity-100');
        alert.classList.add(colors.bg, colors.text, colors.border);
        alert.setAttribute('role', 'alert');

        // Get the appropriate icon based on type
        let iconSvg = '';
        if (type === 'success') {
            iconSvg = `<svg class="h-5 w-5 ${colors.iconColor}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="flex">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button type="button" class="inline-flex bg-transparent rounded-md p-1.5 text-gray-500 hover:bg-gray-100 focus:outline-none">
